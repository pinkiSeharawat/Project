...
<button value="next"><a href="Final" style=" color:white; text-align:center; text-decoration: none;">Submit</a></button>
<button value="Cancel"><a href="cancel.jsp" style=" color:white;  text-align:center; text-decoration: none;">Cancel</a></button>
